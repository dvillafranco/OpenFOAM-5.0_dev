...
Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::SchnerrSauer
(
...
Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::rRb
(
...
Foam::tmp<Foam::volScalarField>
Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::alphaNuc
(
...
Foam::tmp<Foam::volScalarField>
Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::pCoeff
(
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField pCoeff(this->pCoeff(p));
    const volScalarField& n_ = alpha1_.db().lookupObject<volScalarField>("n_");
...
void Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::correct()
{}


bool Foam::phaseChangeTwoPhaseMixturesNuc::SchnerrSauer::read()
{
