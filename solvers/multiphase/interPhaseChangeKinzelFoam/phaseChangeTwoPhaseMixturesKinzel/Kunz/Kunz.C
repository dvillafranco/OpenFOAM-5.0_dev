...
namespace phaseChangeTwoPhaseMixturesNuc
{
    ...
    addToRunTimeSelectionTable(phaseChangeTwoPhaseMixtureNuc, Kunz, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::Kunz
(
...
Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::mDotAlphal() const
{
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::pCoeffChange() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    return Pair<tmp<volScalarField>>
    (
...
Foam::Pair<Foam::tmp<Foam::volScalarField>>
Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::mDotP() const
{
    const volScalarField& p = alpha1_.db().lookupObject<volScalarField>("p");
    volScalarField limitedAlpha1(min(max(alpha1_, scalar(0)), scalar(1)));
...
void Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::correct()
{}


bool Foam::phaseChangeTwoPhaseMixturesNuc::Kunz::read()
{
